...
with DailySales as (
	...
	from AdventureWorksDW.dbo.FactOrders group by CustomerKey, DateKey
)
...
with PurchaseDate as (
	...
	from AdventureWorksDW.dbo.FactOrders f join AdventureWorksDW.dbo.DimDate d
...
with TotalSpending as(
	...
	from AdventureWorksDW.dbo.FactOrders group by CustomerKey
)
